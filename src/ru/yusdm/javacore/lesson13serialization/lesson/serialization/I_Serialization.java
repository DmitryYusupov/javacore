...
public class I_Serialization {
    ...
    private static class Person implements Serializable {
       ...
       // private String name;
        ...
        public Person(String lastName, Passport passport, SecretKey secretKey) {
         //   this.name = name;
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        Person person1 = readDataFromFile("C:\\Users\\Admin\\AppData\\Local\\Temp\\lesson135141798586143549761.txt");
