package ru.yusdm.javacore.lesson24web.autoservice.user.repo.impl.jdbc;

import ru.yusdm.javacore.lesson24web.autoservice.common.business.exception.jdbc.ResultSetMappingException;
import ru.yusdm.javacore.lesson24web.autoservice.user.domain.ClientType;
import ru.yusdm.javacore.lesson24web.autoservice.user.domain.User;
import ru.yusdm.javacore.lesson24web.autoservice.user.exception.unchecked.UnknownUserClientTypeException;
