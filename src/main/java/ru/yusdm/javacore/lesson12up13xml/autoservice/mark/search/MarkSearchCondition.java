...
import static ru.yusdm.javacore.lesson12up13xml.autoservice.common.solutions.utils.StringUtils.isNotBlank;

public class MarkSearchCondition extends BaseSearchCondition<Long> {

    private String name;
    private String country;
    private ru.yusdm.javacore.lesson12up13xml.autoservice.mark.search.MarkOrderByField orderByField;
    ...
    public ru.yusdm.javacore.lesson12up13xml.autoservice.mark.search.MarkOrderByField getOrderByField() {
        return orderByField;
    }
