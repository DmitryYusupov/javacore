...
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.mark.repo.impl.memory.MarkCollectionRepo;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.mark.service.MarkService;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.mark.service.impl.MarkDefaultService;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.model.repo.ModelRepo;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.model.repo.impl.memory.ModelCollectionRepo;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.model.service.ModelService;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.model.service.impl.ModelDefaultService;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.order.repo.OrderRepo;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.order.repo.impl.memory.OrderCollectionRepo;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.order.service.OrderService;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.order.service.impl.OrderDefaultService;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.user.repo.UserRepo;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.user.repo.impl.memory.UserCollectionRepo;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.user.service.UserService;
import ru.yusdm.javacore.lesson21regularexpressions.autoservice.user.service.impl.UserDefaultService;
