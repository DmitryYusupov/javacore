...
import ru.yusdm.javacore.lesson15concurrency.autoservice.storage.initor.exception.cheked.MarkModelParseXmlFileException;

import java.io.File;
import java.util.ArrayList;
import java.util.List;

import static ru.yusdm.javacore.lesson15concurrency.autoservice.storage.initor.exception.InitDataExceptionMeta.PARSE_MARK_MODEL_ERROR;
